...
class freq(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "freq")
        ...
        self._frequency_slider_range = qtgui.Range(87.9*10**6, 107.9*10**6, 200*10**3, 87.9*10**6, 200)
...
def main(top_block_cls=freq, options=None):
